...
public class QnaReplyAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		dto.setQ_ref(Integer.parseInt(request.getParameter("q_ref")));
		dto.setQ_lev(Integer.parseInt(request.getParameter("q_lev")));
		...
		forward.setPath("./QnA/"+class_cd); // classcd따로 받기
