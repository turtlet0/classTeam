...
//    	sUploadURL= 'file_uploader_html5.php'; 	//upload URL
    	sUploadURL= '/LatteClass/se2/photo_uploader/popup/file_uploader_html5.jsp'; 	//upload URL
...
// 	        sCallback : location.href.replace(/\/[^\/]*$/, '') + '/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
 	        sUrl  : '/LatteClass/se2/photo_uploader/popup/file_uploader.jsp', // 사진 업로드할 서버의 경로
 	        sCallback : '/LatteClass/se2/photo_uploader/popup/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
