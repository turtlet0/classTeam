...
public class FileUploadAction implements Action{
	...
	public ActionForward execute(HttpServletRequest request, 
		...
		//실제 파일 저장 위치 : D:\workspace_mocaclass\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\LatteClass/upload/~
		...
		/*./member/list.jsp 페이지로 정보 가져와 출력*/
		ActionForward forward = new ActionForward();
		
		forward.setPath("./file/imgUploadPro.jsp");
